...
if __name__ == "__main__":
	...
	parser.add_argument('--video_path', default="Examples/test_video.mp4", type=str, help='input video path.')
	parser.add_argument('--lane_det_model_path', default="Models/culane_res18.trt", type=str, help='lane detection model path.')
	parser.add_argument('--object_det_model_path', default="Models/yolov8l.trt", type=str, help='object detection model path.')
	parser.add_argument('--verbose', action='store_true', default=False, help='TensorRT: verbose log')
	args = parser.parse_args()

	lane_config = {
	"model_path": args.lane_det_model_path,
	"model_type" : LaneModelType.UFLDV2_CULANE
	}

	object_config = {
		"model_path": args.object_det_model_path,
	...
	vout = cv2.VideoWriter(args.video_path[:-4]+'_result.mp4', fourcc , 30.0, (width, height))
